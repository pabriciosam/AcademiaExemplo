import { Icon, ToastTitle } from "@gluestack-ui/themed";
import { Toast, ToastDescription, VStack, Pressable } from "@gluestack-ui/themed";
...
export function ToastMessagem({ id, title, description, action = "success", onClose }: Props) {
  return (
    <Toast
      nativeID={`toast-${id}`}
      action={action}
